...
@Component({
  selector: 'app-user-president',
  templateUrl: './user-president.component.html',
  styleUrls: ['./user-president.component.css']
})
export class UserPresidentComponent {
infosyId
	decision
	niveau_acte
	info_full
  ...
  search() {	 
		...
		let info_user_by_cin = this.full_info.listUser
		  var infobycin = info_user_by_cin.filter(function(el){
  ...
  logout() {
	...
	getinfobyId(infosyId) {
		this.show_detail = true
		console.log(infosyId)
		this.infosyId = infosyId
		this.date_act = this.infosyId.date_act
		this.decision = this.infosyId.decision
		this.niveau_acte = this.infosyId.niveau_acte
		this.info_full = this.infosyId.info_full
		this.name_acte = this.infosyId.name_acte
	}
